...
public final class Config
{
	...
	private static final void loadEvents()
	{
		...
		Config.OLY_START_TIME = events.getProperty("OlyStartTime", 18);
		Config.OLY_MIN = events.getProperty("OlyMin", 0);
		Config.OLY_CPERIOD = events.getProperty("OlyCPeriod", 21600000L);
		Config.OLY_BATTLE = events.getProperty("OlyBattle", 180000L);
		Config.OLY_WPERIOD = events.getProperty("OlyWPeriod", 604800000L);
		Config.OLY_VPERIOD = events.getProperty("OlyVPeriod", 86400000L);
		Config.OLY_WAIT_TIME = events.getProperty("OlyWaitTime", 30);
		Config.OLY_WAIT_BATTLE = events.getProperty("OlyWaitBattle", 60);
		Config.OLY_WAIT_END = events.getProperty("OlyWaitEnd", 40);
		Config.OLY_START_POINTS = events.getProperty("OlyStartPoints", 18);
		Config.OLY_WEEKLY_POINTS = events.getProperty("OlyWeeklyPoints", 3);
		Config.OLY_MIN_MATCHES = events.getProperty("OlyMinMatchesToBeClassed", 5);
		Config.OLY_CLASSED = events.getProperty("OlyClassedParticipants", 5);
		Config.OLY_NONCLASSED = events.getProperty("OlyNonClassedParticipants", 9);
		Config.OLY_CLASSED_REWARD = events.parseIntIntList("OlyClassedReward", "6651-50");
		Config.OLY_NONCLASSED_REWARD = events.parseIntIntList("OlyNonClassedReward", "6651-30");
		Config.OLY_GP_PER_POINT = events.getProperty("OlyGPPerPoint", 1000);
		Config.OLY_HERO_POINTS = events.getProperty("OlyHeroPoints", 300);
		Config.OLY_RANK1_POINTS = events.getProperty("OlyRank1Points", 100);
		Config.OLY_RANK2_POINTS = events.getProperty("OlyRank2Points", 75);
		Config.OLY_RANK3_POINTS = events.getProperty("OlyRank3Points", 55);
		Config.OLY_RANK4_POINTS = events.getProperty("OlyRank4Points", 40);
		Config.OLY_RANK5_POINTS = events.getProperty("OlyRank5Points", 30);
		Config.OLY_MAX_POINTS = events.getProperty("OlyMaxPoints", 10);
		Config.OLY_DIVIDER_CLASSED = events.getProperty("OlyDividerClassed", 3);
		Config.OLY_DIVIDER_NON_CLASSED = events.getProperty("OlyDividerNonClassed", 5);
		Config.OLY_ANNOUNCE_GAMES = events.getProperty("OlyAnnounceGames", true);
		Config.OLY_ENCHANT_LIMIT = events.getProperty("OlyMaxEnchant", -1);
		...
		Config.CTF_EVENT_ENABLED = events.getProperty("CTFEventEnabled", false);
		Config.CTF_EVENT_INTERVAL = events.getProperty("CTFEventInterval", "20:00").split(",");
		Config.CTF_EVENT_PARTICIPATION_TIME = events.getProperty("CTFEventParticipationTime", 3600);
		Config.CTF_EVENT_RUNNING_TIME = events.getProperty("CTFEventRunningTime", 1800);
		Config.CTF_NPC_LOC_NAME = events.getProperty("CTFNpcLocName", "Giran Town");
		Config.CTF_EVENT_PARTICIPATION_NPC_ID = events.getProperty("CTFEventParticipationNpcId", 0);
		Config.CTF_EVENT_TEAM_1_HEADQUARTERS_ID = events.getProperty("CTFEventFirstTeamHeadquartersId", 0);
		Config.CTF_EVENT_TEAM_2_HEADQUARTERS_ID = events.getProperty("CTFEventSecondTeamHeadquartersId", 0);
		Config.CTF_EVENT_TEAM_1_FLAG = events.getProperty("CTFEventFirstTeamFlag", 0);
		Config.CTF_EVENT_TEAM_2_FLAG = events.getProperty("CTFEventSecondTeamFlag", 0);
		Config.CTF_EVENT_CAPTURE_SKILL = events.getProperty("CTFEventCaptureSkillId", 0);
		...
		else
		{
			...
			else
			{
				...
				Config.CTF_EVENT_MIN_PLAYERS_IN_TEAMS = events.getProperty("CTFEventMinPlayersInTeams", 1);
				Config.CTF_EVENT_MAX_PLAYERS_IN_TEAMS = events.getProperty("CTFEventMaxPlayersInTeams", 20);
				Config.CTF_EVENT_MIN_LVL = Byte.parseByte(events.getProperty("CTFEventMinPlayerLevel", "1"));
				Config.CTF_EVENT_MAX_LVL = Byte.parseByte(events.getProperty("CTFEventMaxPlayerLevel", "80"));
				Config.CTF_EVENT_RESPAWN_TELEPORT_DELAY = events.getProperty("CTFEventRespawnTeleportDelay", 20);
				Config.CTF_EVENT_START_LEAVE_TELEPORT_DELAY = events.getProperty("CTFEventStartLeaveTeleportDelay", 20);
				Config.CTF_EVENT_EFFECTS_REMOVAL = events.getProperty("CTFEventEffectsRemoval", 0);
				Config.CTF_EVENT_TEAM_1_NAME = events.getProperty("CTFEventTeam1Name", "Team1");
				Config.CTF_EVENT_TEAM_2_NAME = events.getProperty("CTFEventTeam2Name", "Team2");
				...
				else
				{
					...
					else
					{
						...
						Config.CTF_EVENT_TARGET_TEAM_MEMBERS_ALLOWED = events.getProperty("CTFEventTargetTeamMembersAllowed", true);
						Config.CTF_EVENT_SCROLL_ALLOWED = events.getProperty("CTFEventScrollsAllowed", false);
						Config.CTF_EVENT_POTIONS_ALLOWED = events.getProperty("CTFEventPotionsAllowed", false);
						Config.CTF_EVENT_SUMMON_BY_ITEM_ALLOWED = events.getProperty("CTFEventSummonByItemAllowed", false);
						Config.CTF_REWARD_TEAM_TIE = events.getProperty("CTFRewardTeamTie", false);
		...
		Config.DM_EVENT_ENABLED = events.getProperty("DMEventEnabled", false);
		Config.DM_EVENT_INTERVAL = events.getProperty("DMEventInterval", "8:00,14:00,20:00,2:00").split(",");
		...
		Config.DM_EVENT_RUNNING_TIME = events.getProperty("DMEventRunningTime", 1800);
		Config.DM_NPC_LOC_NAME = events.getProperty("DMNpcLocName", "Giran Town");
		Config.DM_EVENT_PARTICIPATION_NPC_ID = events.getProperty("DMEventParticipationNpcId", 0);
		Config.DM_SHOW_TOP_RANK = events.getProperty("DMShowTopRank", false);
		Config.DM_TOP_RANK = events.getProperty("DMTopRank", 10);
		...
		else
		{
			...
			else if (Config.DM_EVENT_ENABLED)
			{
				...
				Config.DM_EVENT_MIN_PLAYERS = events.getProperty("DMEventMinPlayers", 1);
				Config.DM_EVENT_MAX_PLAYERS = events.getProperty("DMEventMaxPlayers", 20);
				Config.DM_EVENT_MIN_LVL = (byte) events.getProperty("DMEventMinPlayerLevel", 1);
				Config.DM_EVENT_MAX_LVL = (byte) events.getProperty("DMEventMaxPlayerLevel", 80);
				Config.DM_EVENT_RESPAWN_TELEPORT_DELAY = events.getProperty("DMEventRespawnTeleportDelay", 20);
				Config.DM_EVENT_START_LEAVE_TELEPORT_DELAY = events.getProperty("DMEventStartLeaveTeleportDelay", 20);
				Config.DM_EVENT_EFFECTS_REMOVAL = events.getProperty("DMEventEffectsRemoval", 0);
				...
				Config.DM_REWARD_FIRST_PLAYERS = events.getProperty("DMRewardFirstPlayers", 3);
				...
				Config.DM_EVENT_SCROLL_ALLOWED = events.getProperty("DMEventScrollsAllowed", false);
				Config.DM_EVENT_POTIONS_ALLOWED = events.getProperty("DMEventPotionsAllowed", false);
				Config.DM_EVENT_SUMMON_BY_ITEM_ALLOWED = events.getProperty("DMEventSummonByItemAllowed", false);
				Config.DM_REWARD_PLAYERS_TIE = events.getProperty("DMRewardPlayersTie", false);

				Config.DISABLE_ID_CLASSES_STRING = events.getProperty("DMDisabledForClasses");
			...
			Config.LM_EVENT_ENABLED = events.getProperty("LMEventEnabled", false);
			Config.LM_EVENT_INTERVAL = events.getProperty("LMEventInterval", "8:00,14:00,20:00,2:00").split(",");
			...
			Config.LM_EVENT_RUNNING_TIME = events.getProperty("LMEventRunningTime", 1800);
			Config.LM_NPC_LOC_NAME = events.getProperty("LMNpcLocName", "Giran Town");
			Config.LM_EVENT_PARTICIPATION_NPC_ID = events.getProperty("LMEventParticipationNpcId", 0);
			...
			else
			{
				...
				else if (Config.LM_EVENT_ENABLED)
				{
					...
					Config.LM_EVENT_MIN_PLAYERS = events.getProperty("LMEventMinPlayers", 1);
					Config.LM_EVENT_MAX_PLAYERS = events.getProperty("LMEventMaxPlayers", 20);
					Config.LM_EVENT_MIN_LVL = (byte) events.getProperty("LMEventMinPlayerLevel", 1);
					Config.LM_EVENT_MAX_LVL = (byte) events.getProperty("LMEventMaxPlayerLevel", 80);
					Config.LM_EVENT_RESPAWN_TELEPORT_DELAY = events.getProperty("LMEventRespawnTeleportDelay", 20);
					Config.LM_EVENT_START_LEAVE_TELEPORT_DELAY = events.getProperty("LMEventStartLeaveTeleportDelay", 20);
					Config.LM_EVENT_EFFECTS_REMOVAL = events.getProperty("LMEventEffectsRemoval", 0);
					...
					Config.LM_EVENT_SCROLL_ALLOWED = events.getProperty("LMEventScrollsAllowed", false);
					Config.LM_EVENT_POTIONS_ALLOWED = events.getProperty("LMEventPotionsAllowed", false);
					Config.LM_EVENT_SUMMON_BY_ITEM_ALLOWED = events.getProperty("LMEventSummonByItemAllowed", false);
					Config.LM_REWARD_PLAYERS_TIE = events.getProperty("LMRewardPlayersTie", false);

					Config.DISABLE_ID_CLASSES_STRING = events.getProperty("LMDisabledForClasses");
					Config.DISABLE_ID_CLASSES = new ArrayList<>();
				...
				Config.TVT_EVENT_ENABLED = events.getProperty("TvTEventEnabled", false);
				Config.TVT_EVENT_INTERVAL = events.getProperty("TvTEventInterval", "20:00").split(",");
				Config.TVT_EVENT_PARTICIPATION_TIME = events.getProperty("TvTEventParticipationTime", 3600);
				Config.TVT_EVENT_RUNNING_TIME = events.getProperty("TvTEventRunningTime", 1800);
				Config.TVT_NPC_LOC_NAME = events.getProperty("TvTNpcLocName", "Giran Town");
				Config.TVT_EVENT_PARTICIPATION_NPC_ID = events.getProperty("TvTEventParticipationNpcId", 0);
				...
				else
				{
					...
					else
					{
						...
						Config.TVT_EVENT_MIN_PLAYERS_IN_TEAMS = events.getProperty("TvTEventMinPlayersInTeams", 1);
						Config.TVT_EVENT_MAX_PLAYERS_IN_TEAMS = events.getProperty("TvTEventMaxPlayersInTeams", 20);
						Config.TVT_EVENT_MIN_LVL = Byte.parseByte(events.getProperty("TvTEventMinPlayerLevel", "1"));
						Config.TVT_EVENT_MAX_LVL = Byte.parseByte(events.getProperty("TvTEventMaxPlayerLevel", "80"));
						Config.TVT_EVENT_RESPAWN_TELEPORT_DELAY = events.getProperty("TvTEventRespawnTeleportDelay", 20);
						Config.TVT_EVENT_START_LEAVE_TELEPORT_DELAY = events.getProperty("TvTEventStartLeaveTeleportDelay", 20);
						Config.TVT_EVENT_EFFECTS_REMOVAL = events.getProperty("TvTEventEffectsRemoval", 0);
						Config.TVT_EVENT_TEAM_1_NAME = events.getProperty("TvTEventTeam1Name", "Team1");
						...
						else
						{
							...
							Config.TVT_EVENT_TEAM_2_NAME = events.getProperty("TvTEventTeam2Name", "Team2");
							...
							else
							{
								...
								Config.TVT_EVENT_TARGET_TEAM_MEMBERS_ALLOWED = events.getProperty("TvTEventTargetTeamMembersAllowed", true);
								Config.TVT_EVENT_SCROLL_ALLOWED = events.getProperty("TvTEventScrollsAllowed", false);
								Config.TVT_EVENT_POTIONS_ALLOWED = events.getProperty("TvTEventPotionsAllowed", false);
								Config.TVT_EVENT_SUMMON_BY_ITEM_ALLOWED = events.getProperty("TvTEventSummonByItemAllowed", false);
								Config.TVT_REWARD_TEAM_TIE = events.getProperty("TvTRewardTeamTie", false);
								...
								Config.TVT_REWARD_PLAYER = events.getProperty("TvTRewardOnlyKillers", false);

								Config.TVT_EVENT_ON_KILL = events.getProperty("TvTEventOnKill", "pmteam");
								Config.DISABLE_ID_CLASSES_STRING_TVT = events.getProperty("TvTDisabledForClasses");
								...
								Config.ALLOW_TVT_DLG = events.getProperty("AllowDlgTvTInvite", false);
								Config.TVT_EVENT_MAX_PARTICIPANTS_PER_IP = events.getProperty("TvTEventMaxParticipantsPerIP", 0);
							}
						}
					}
				}
