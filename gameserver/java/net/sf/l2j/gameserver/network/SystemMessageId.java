...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId S1_HP_DECREASED_EFFECT_APPLIES;

	/**
	 * ID: 1134<br>
	 * Message: Since HP has increased, the effect of $s1 will disappear.
	 */
	public static final SystemMessageId S1_HP_INCREASED_EFFECT_DISAPPEARS;
	 ...
	 */
	public static final SystemMessageId CLAN_ACADEMY_MEMBER_S1_HAS_SUCCESSFULLY_COMPLETED_THE_2ND_CLASS_TRANSFER_AND_OBTAINED_S2_CLAN_REPUTATION_POINTS;
	...
	static
	{
		...
		S1_HP_DECREASED_EFFECT_APPLIES = new SystemMessageId(1133);
		S1_HP_INCREASED_EFFECT_DISAPPEARS = new SystemMessageId(1134);
		...
		CLAN_ACADEMY_MEMBER_S1_HAS_SUCCESSFULLY_COMPLETED_THE_2ND_CLASS_TRANSFER_AND_OBTAINED_S2_CLAN_REPUTATION_POINTS = new SystemMessageId(1748);
