...
public final class RequestActionUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		switch (_actionId)
		{
			...
			case 21: // Change Movement Mode (pet follow/stop)
				...
				if ((summon == null) || (summon.getAI().getFollowStatus() && !player.isIn3DRadius(summon, 2000)))
				{
					return;
				}
	...
	private boolean useSkill(int skillId, WorldObject target)
	{
		...
		if ((skill == null) || (summon instanceof Pet && summon.getStatus().getLevel() - player.getStatus().getLevel() > 20))
		{
			return false;
		}
