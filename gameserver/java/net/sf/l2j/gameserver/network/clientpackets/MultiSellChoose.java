...
public class MultiSellChoose extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		if (!getClient().performAction(FloodProtector.MULTISELL) || _amount < 1 || _amount > 9999)
		{
		...
		for (Ingredient e : ingredientsList)
		{
			...
			else // if this is not a list that maintains enchantment, check the count of all items that have the given id.
