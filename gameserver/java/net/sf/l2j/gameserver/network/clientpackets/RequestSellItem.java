...
public final class RequestSellItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (merchant == null || !player.getAI().canDoInteract(merchant) || (_listId > 1000000 && merchant.getTemplate().getNpcId() != _listId - 1000000))
		{
			return;
		}
		...
		{
			final String content = HtmCache.getInstance().getHtm(player.isLang() + "" + htmlFolder + "/" + merchant.getNpcId() + "-sold.htm");
			if (content != null)
			{
