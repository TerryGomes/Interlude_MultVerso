...
public final class RequestHennaEquip extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!player.reduceAdena("Henna", henna.getDrawPrice(), player.getCurrentFolk(), true) || !player.destroyItemByItemId("Henna", henna.getDyeId(), Henna.DRAW_AMOUNT, player, true))
		{
			return;
		}
