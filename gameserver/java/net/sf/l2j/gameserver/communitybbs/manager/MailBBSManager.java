...
public class MailBBSManager extends BaseBBSManager
{
	...
	private void showMailList(Player player, int page, MailType type, String sType, String search)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "mail/mail.htm");
	...
	private void showMailView(Player player, Mail mail)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "mail/mail-show.htm");
	...
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "mail/mail-write.htm");
		separateAndSend(content, player);
	}

	private static void showWriteView(Player player, Mail mail)
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "mail/mail-reply.htm");
