...
public class ClanBBSManager extends BaseBBSManager
{
	...
	private static void sendClanMail(Player player, int clanId)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome-mail.htm");
	...
	private static void sendClanManagement(Player player, int clanId)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome-management.htm");
	...
	private static void sendClanNotice(Player player, int clanId)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome-notice.htm");
		content = content.replaceAll("%clanid%", Integer.toString(clan.getClanId()));
	...
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanlist.htm");
	...
	private static void sendClanDetails(Player player, int clanId)
	{
		...
		{
			content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome.htm");
		}
		else if (player.isClanLeader())
		{
			content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome-leader.htm");
		}
		else
		{
			content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "clan/clanhome-member.htm");
		}
