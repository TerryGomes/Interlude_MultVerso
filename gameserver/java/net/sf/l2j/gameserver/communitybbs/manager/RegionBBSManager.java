...
public class RegionBBSManager extends BaseBBSManager
{
	...
	{
		final String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "region/castlelist.htm");
	...
	private static void showRegion(Player player, int castleId)
	{
		...
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "region/castle.htm");
