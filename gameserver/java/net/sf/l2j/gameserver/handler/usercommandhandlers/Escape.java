...
public class Escape implements IUserCommandHandler
{
	...
	{
		if (!CTFEvent.onEscapeUse(player.getObjectId()) || !DMEvent.onEscapeUse(player.getObjectId()) || !LMEvent.onEscapeUse(player.getObjectId()) || !TvTEvent.onEscapeUse(player.getObjectId()) || player.isInOlympiadMode() || player.isInObserverMode() || player.isFestivalParticipant() || player.isInJail() || player.isInsideZone(ZoneId.BOSS))
		{
