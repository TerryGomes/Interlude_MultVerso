...
public class Continuous implements ISkillHandler
{
	...
	public void useSkill(Creature activeChar, L2Skill skill, WorldObject[] targets, ItemInstance itemInstance)
	{
		...
		for (WorldObject obj : targets)
		{
			...
			if ((skill.getSkillType() == SkillType.BUFF || skill.getSkillType() == SkillType.HEAL_PERCENT || skill.getSkillType() == SkillType.REFLECT || skill.getSkillType() == SkillType.COMBATPOINTHEAL) && target.isInvul())
			{
				continue;
			}
