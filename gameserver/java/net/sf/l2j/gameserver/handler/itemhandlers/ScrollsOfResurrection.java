		...
		if (target.isDead())
		{
			...
			if (targetPlayer != null || targetPet != null)
			{
				...
				if (targetPlayer != null)
				{
					...
					if (!CTFEvent.onScrollUse(targetPlayer.getObjectId()) || !DMEvent.onScrollUse(targetPlayer.getObjectId()) || !LMEvent.onScrollUse(targetPlayer.getObjectId()) || !TvTEvent.onScrollUse(targetPlayer.getObjectId()))
					{
