...
public class SummonItems implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		if (!TvTEvent.onItemSummon(playable.getObjectId()) || !LMEvent.onItemSummon(playable.getObjectId()) || !DMEvent.onItemSummon(playable.getObjectId()))
		{
			return;
		}
		...
		if (player.isInObserverMode() || player.isAllSkillsDisabled() || player.getCast().isCastingNow())
		{
			return;
		}
