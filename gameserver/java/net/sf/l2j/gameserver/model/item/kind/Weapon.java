...
public final class Weapon extends Item
{
	...
	public void castSkillOnCrit(Creature caster, Creature target)
	{
		...
		if ((skillOnCrit == null) || (_skillOnCritCondition != null && !_skillOnCritCondition.test(caster, target, skillOnCrit)))
		{
			return;
		}
	...
	public void castSkillOnMagic(Creature caster, Creature target, L2Skill trigger)
	{
		...
		if ((skillOnMagic == null) || (trigger.isOffensive() != skillOnMagic.isOffensive()) || trigger.isToggle() || trigger.isPotion())
		{
			return;
		}
