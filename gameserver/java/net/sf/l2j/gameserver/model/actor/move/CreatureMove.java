...
public class CreatureMove<T extends Creature>
{
	...
	public boolean moveToNextRoutePoint()
	{
		...
		if (_task == null || _geoPath.isEmpty() || _actor.getStatus().getMoveSpeed() <= 0 || _actor.isMovementDisabled())
		{
			return false;
		}
	...
	{
		if ((weaponAttackRange < 0) || _actor.isIn2DRadius(target, (int) (weaponAttackRange + _actor.getCollisionRadius() + target.getCollisionRadius())))
		{
			return false;
		}
