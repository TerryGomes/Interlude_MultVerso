...
public class Boat extends Creature
{
	...
	public void addPassenger(Player player)
	{
		...
		if (player.getBoat() == null || (player.getBoat() != null && player.getBoat() != this) || !_passengers.add(player))
		{
			return;
		}
	...
	public void payForRide(int itemId, int count, Location loc)
	{
		...
		final Collection<Player> passengers = getKnownTypeInRadius(Player.class, 1000);
