...
public class CastleGatekeeper extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		if (command.startsWith("tele"))
		{
			...
			html.setFile(player.isLang() + "castleteleporter/MassGK-1.htm");
	...
	public void showChatWindow(Player player)
	{
		...
		if (_teleportTask == null)
		{
			...
			{
				html.setFile(player.isLang() + "castleteleporter/MassGK-2.htm");
			}
			else
			{
				html.setFile(player.isLang() + "castleteleporter/MassGK.htm");
			}
		}
		else
		{
