...
public class ClanHallManagerNpc extends Merchant
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (actualCommand.equalsIgnoreCase("banish_foreigner"))
		{
			...
			{
				html.setFile(player.isLang() + "clanHallManager/banish-list.htm");
			}
			else if (val.equalsIgnoreCase("banish"))
			{
				getClanHall().banishForeigners();
				html.setFile(player.isLang() + "clanHallManager/banish.htm");
			}
		...
		else if (actualCommand.equalsIgnoreCase("manage_vault"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player.isLang() + "clanHallManager/vault.htm");
		...
		else if (actualCommand.equalsIgnoreCase("door"))
		{
			...
			if (val.equalsIgnoreCase("open"))
			{
				...
				html.setFile(player.isLang() + "clanHallManager/door-open.htm");
			}
			else if (val.equalsIgnoreCase("close"))
			{
				getClanHall().openCloseDoors(false);
				html.setFile(player.isLang() + "clanHallManager/door-close.htm");
			}
			else
			{
				html.setFile(player.isLang() + "clanHallManager/door.htm");
			}
		...
		else if (actualCommand.equalsIgnoreCase("functions"))
		{
			...
			if (val.equalsIgnoreCase("tele"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.isLang() + "clanHallManager/chamberlain-nac.htm");
					html.replace("%objectId%", getObjectId());
					player.sendPacket(html);
					return;
				}
			...
			else if (val.equalsIgnoreCase("support"))
			{
				...
				{
					html.setFile(player.isLang() + "clanHallManager/support" + chf.getLvl() + ".htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.isLang() + "clanHallManager/functions.htm");
		...
		else if (actualCommand.equalsIgnoreCase("manage"))
		{
			...
			if (val.equalsIgnoreCase("recovery"))
			{
				if (st.hasMoreTokens())
				{
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.isLang() + "clanHallManager/functions-cancel.htm");
					...
					{
						final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.isLang() + "clanHallManager/functions-apply.htm");
					...
					else if (val.equalsIgnoreCase("hp"))
					{
						...
						{
							html.setFile(player.isLang() + "clanHallManager/functions-used.htm");
						...
						html.setFile(player.isLang() + "clanHallManager/functions-apply_confirmed.htm");
						...
						switch (percent)
						{
							case 0:
								fee = 0;
								html.setFile(player.isLang() + "clanHallManager/functions-cancel_confirmed.htm");
								break;
						...
						{
							html.setFile(player.isLang() + "clanHallManager/low_adena.htm");
						}
						else
						{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.isLang() + "clanHallManager/edit_recovery.htm");
			...
			else if (val.equalsIgnoreCase("other"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.isLang() + "clanHallManager/edit_other.htm");
			...
			else if (val.equalsIgnoreCase("deco"))
			{
				...
				{
					final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.isLang() + "clanHallManager/deco.htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player.isLang() + "clanHallManager/manage.htm");
				html.replace("%objectId%", getObjectId());
				player.sendPacket(html);
			}
		}
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player.isLang() + "clanHallManager/chamberlain.htm");
		...
		else if (actualCommand.equalsIgnoreCase("support_back"))
		{
			...
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player.isLang() + "clanHallManager/support" + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() + ".htm");
			html.replace("%mp%", (int) getStatus().getMp());
			html.replace("%objectId%", getObjectId());
			player.sendPacket(html);
		}
	...
	public void showChatWindow(Player player)
	{
		...
		final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
		html.setFile(player.isLang() + "clanHallManager/chamberlain" + ((getNpcTalkCond(player) == NpcTalkCond.OWNER) ? ".htm" : "-no.htm"));
		html.replace("%objectId%", getObjectId());
		player.sendPacket(html);
	}
	...
	private boolean validatePrivileges(Player player, int privilege)
	{
		...
		{
			final NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player.isLang() + "clanHallManager/not_authorized.htm");
			player.sendPacket(html);
			return false;
		}
		return true;
