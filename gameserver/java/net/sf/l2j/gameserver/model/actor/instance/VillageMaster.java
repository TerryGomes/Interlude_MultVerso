...
public class VillageMaster extends Folk
{
	...
	public String getHtmlPath(Player player, int npcId, int val)
	{
		...
		return player.isLang() + "villagemaster/" + filename + ".htm";
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("change_clan_leader"))
		{
			...
			if (clan.getNewLeaderId() == 0)
			{
				...
				html.setFile(player.isLang() + "script/feature/Clan/9000-07-success.htm");
			}
			else
			{
				html.setFile(player.isLang() + "script/feature/Clan/9000-07-in-progress.htm");
			}
		...
		else if (actualCommand.equalsIgnoreCase("cancel_clan_leader_change"))
		{
			...
			if (clan.getNewLeaderId() != 0)
			{
				...
				html.setFile(player.isLang() + "script/feature/Clan/9000-08-success.htm");
			}
			else
			{
				html.setFile(player.isLang() + "script/feature/Clan/9000-08-no.htm");
			}
		...
		else if (command.startsWith("Subclass"))
		{
			...
			switch (cmdChoice)
			{
				case 0: // Subclass change menu
					html.setFile(player.isLang() + "villagemaster/SubClass.htm");
					break;
				...
				case 1: // Add Subclass - Initial
					...
					{
						html.setFile(player.isLang() + "villagemaster/SubClass_Fail.htm");
						break;
					}
					...
					html.setFile(player.isLang() + "villagemaster/SubClass_Add.htm");
				...
				case 2: // Change Class - Initial
					...
					{
						html.setFile(player.isLang() + "villagemaster/SubClass_ChangeNo.htm");
					}
					else
					{
						sb = new StringBuilder(300);
						...
						if (sb.length() > 0)
						{
							html.setFile(player.isLang() + "villagemaster/SubClass_Change.htm");
							html.replace("%list%", sb.toString());
						}
						else
						{
							html.setFile(player.isLang() + "villagemaster/SubClass_ChangeNotFound.htm");
						}
					}
					break;
				...
				case 3: // Change/Cancel Subclass - Initial
					if (player.getSubClasses().isEmpty())
					{
						html.setFile(player.isLang() + "villagemaster/SubClass_ModifyEmpty.htm");
						break;
					}

					html.setFile(player.isLang() + "villagemaster/SubClass_Modify.htm");
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					if (allowAddition && isValidNewSubClass(player, paramOne))
					{
						...
						html.setFile(player.isLang() + "villagemaster/SubClass_AddOk.htm");
				...
				case 5: // Change Class - Action
					...
					{
						html.setFile(player.isLang() + "villagemaster/SubClass_Current.htm");
						break;
					}
				...
				case 6: // Change/Cancel Subclass - Choice
					...
					{
						case 1:
							html.setFile(player.isLang() + "villagemaster/SubClass_ModifyChoice1.htm");
							break;

						case 2:
							html.setFile(player.isLang() + "villagemaster/SubClass_ModifyChoice2.htm");
							break;

						case 3:
							html.setFile(player.isLang() + "villagemaster/SubClass_ModifyChoice3.htm");
							break;

						default:
							html.setFile(player.isLang() + "villagemaster/SubClass_ModifyChoice.htm");
					}
					html.replace("%list%", sb.toString());
					break;

				case 7: // Change Subclass - Action
					if (!player.getClient().performAction(FloodProtector.SUBCLASS) || !isValidNewSubClass(player, paramTwo))
					{
						return;
					}
					...
					if (player.modifySubClass(paramOne, paramTwo))
					{
						...
						html.setFile(player.isLang() + "villagemaster/SubClass_ModifyOk.htm");
	...
	private static final void assignSubPledgeLeader(Player player, String clanName, String leaderName)
	{
		...
		if (leaderSubPledge == null || leaderSubPledge.getPledgeType() != 0 || clan.isSubPledgeLeader(leaderSubPledge.getObjectId()))
		{
	...
	public static final void showPledgeSkillList(Player player)
	{
		if (!player.isClanLeader())
		{
			...
			html.setFile(player.isLang() + "script/feature/Clan/9000-09-no.htm");
			player.sendPacket(html);
