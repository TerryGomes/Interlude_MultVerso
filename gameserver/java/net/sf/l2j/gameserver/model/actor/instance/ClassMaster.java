...
public final class ClassMaster extends Folk
{
	...
	{
		final ClassId currentClassId = player.getClassId();
		if ((getMinLevel(currentClassId.getLevel()) > player.getStatus().getLevel() && !Config.ALLOW_ENTIRE_TREE) || !validateClassId(currentClassId, val))
		{
			return false;
		}
	...
	private static final boolean validateClassId(ClassId oldCID, ClassId newCID)
	{
		...
		if ((oldCID == newCID.getParent()) || (Config.ALLOW_ENTIRE_TREE && newCID.isChildOf(oldCID)))
		{
			return true;
		}
