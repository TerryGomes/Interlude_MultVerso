...
public abstract class AbstractOlympiadGame
{
	...
	protected static SystemMessage checkDefection(Player player)
	{
		...
		if (CTFEvent.isPlayerParticipant(player.getObjectId()) || DMEvent.isPlayerParticipant(player.getObjectId()) || LMEvent.isPlayerParticipant(player.getObjectId()) || TvTEvent.isPlayerParticipant(player.getObjectId()))
		{
