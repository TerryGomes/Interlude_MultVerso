...
public final class RainbowSpringsChateau extends ClanHallSiege
{
	...
	private final List<Clan> _acceptedClans = new ArrayList<>(4);
	...
	private Spawn[] _gourds = new Spawn[4];
	...
	public String onFirstTalk(Npc npc, Player player)
	{
		...
		if (npcId == MESSENGER)
		{
			...
			html = HtmCache.getInstance().getHtm(player.isLang() + "script/siegablehall/RainbowSpringsChateau/" + main);
	...
	{
		if (!_rainbow.isInSiege() || !(target instanceof Npc))
		{
			return;
		}
