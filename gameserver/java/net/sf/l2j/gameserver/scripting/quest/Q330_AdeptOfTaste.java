				...
				switch (npc.getNpcId())
				{
					...
					case SONIA:
						if (!player.getInventory().hasItems(RED_MANDRAGORA_SAP) && !player.getInventory().hasItems(WHITE_MANDRAGORA_SAP))
						{
							...
							else if (player.getInventory().getItemCount(RED_MANDRAGORA_ROOT) < 40 || player.getInventory().getItemCount(WHITE_MANDRAGORA_ROOT) < 40)
							{
					...
					case JACOB:
						if (!player.getInventory().hasItems(HONEY) && !player.getInventory().hasItems(GOLDEN_HONEY))
						{
							...
							else if (player.getInventory().getItemCount(NECTAR) < 20)
							{
					...
					case PANO:
						if (!player.getInventory().hasItems(DIONIAN_POTATO))
						{
							...
							else if (player.getInventory().getItemCount(HOBGOBLIN_AMULET) < 30)
							{
					...
					case GLYVKA:
						if (!player.getInventory().hasItems(GREEN_MOSS_BUNDLE) && !player.getInventory().hasItems(BROWN_MOSS_BUNDLE))
						{
							...
							else if (player.getInventory().getItemCount(GREEN_MARSH_MOSS) < 20 || player.getInventory().getItemCount(BROWN_MARSH_MOSS) < 20)
							{
					...
					case ROLLANT:
						if (!player.getInventory().hasItems(MONSTER_EYE_MEAT))
						{
							...
							else if (player.getInventory().getItemCount(MONSTER_EYE_BODY) < 30)
							{
