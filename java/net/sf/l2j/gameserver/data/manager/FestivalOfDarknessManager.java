...
public class FestivalOfDarknessManager
{
	...
	{
		if (SevenSignsManager.getInstance().isSealValidationPeriod() || (_managerInstance == null))
		{
			return false;
		}
	...
	private class FestivalManager implements Runnable
	{
		...
		public synchronized void run()
		{
			...
			if (SevenSignsManager.getInstance().isSealValidationPeriod() || (SevenSignsManager.getInstance().getMilliToPeriodChange() < Config.FESTIVAL_CYCLE_LENGTH))
			{
				return;
			}
