...
abstract class AbstractAI<T extends Creature>
{
	...
	{
		if (_actor.denyAiAction() || _actor.isOutOfControl())
		{
			clientActionFailed();
			return;
		}
	...
	{
		if (_actor == target || _actor.denyAiAction() || _actor.isOutOfControl())
		{
			clientActionFailed();
			return;
		}
	...
	{
		if ((target == null) || (World.getInstance().getObject(target.getObjectId()) == null))
		{
			return true;
		}
