...
public class FriendsBBSManager extends BaseBBSManager
{
	...
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "friend/friend-list.htm");
		if (content == null)
		{
			return;
		}
	...
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "friend/friend-blocklist.htm");
		if (content == null)
		{
			return;
		}
	...
	{
		String content = HtmCache.getInstance().getHtm(player.isLang() + CB_PATH + "friend/friend-mail.htm");
		if (content == null)
		{
			return;
		}
